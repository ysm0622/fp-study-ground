...
},{"./lib/ReactPropTypesSecret":29}],25:[function(require,module,exports) {
...
},{"object-assign":24,"fbjs/lib/invariant":13,"fbjs/lib/emptyObject":20,"fbjs/lib/warning":14,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":23}],12:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":25}],15:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":13,"react":12,"fbjs/lib/warning":14,"fbjs/lib/ExecutionEnvironment":15,"object-assign":24,"fbjs/lib/emptyFunction":16,"prop-types/checkPropTypes":23,"fbjs/lib/getActiveElement":17,"fbjs/lib/shallowEqual":18,"fbjs/lib/containsNode":19,"fbjs/lib/emptyObject":20,"fbjs/lib/hyphenateStyleName":21,"fbjs/lib/camelizeStyleName":22}],10:[function(require,module,exports) {
'use strict';
...
var todoEditHandler = function todoEditHandler(todo, actions) {
  return function (e) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('input', {
      ...
      onClick: function onClick() {
        return actions.updateTodo(_extends({}, todo, { done: !todo.done }));
      }
    }),
...
exports.default = function (_ref) {
  ...
  return todos.filter(function (todo) {
    return selected !== 'active' || !todo.done;
  }).filter(function (todo) {
    return selected !== 'completed' || todo.done;
  }).map(function (todo) {
    return _react2.default.createElement(_TodoItem2.default, { key: todo.id, todo: todo, actions: actions });
  }).reverse();
};
},{"react":12,"./TodoItem":31}],32:[function(require,module,exports) {
'use strict';
...
var isSelected = function isSelected(filter, selected) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'a',
      {
        ...
        onClick: function onClick() {
          return actions.selectFilter(filter);
        }
      },
      filter
    )
...
},{"react":12,"./FilterItem":32}],8:[function(require,module,exports) {
'use strict';
...
var _FilterList = require('./components/FilterList');

var _FilterList2 = _interopRequireDefault(_FilterList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var enterHandler = function enterHandler(state, actions) {
  return function (e) {
...
var toggleAllHandler = function toggleAllHandler(state, actions) {
  return function (e) {
    state.todos.every(function (todo) {
      return todo.done;
    }) ? actions.uncheckAllTodos(state) : actions.checkAllTodos(state);
  };
};
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          type: 'checkbox',
          checked: state.todos.every(function (todo) {
            return todo.done;
          }),
        ...
        _react2.default.createElement(
          'ul',
          { className: 'todo-list' },
          _react2.default.createElement(_TodoList2.default, _extends({}, state, { actions: actions }))
        )
      ),
      _react2.default.createElement(
        'footer',
        ...
        _react2.default.createElement(
          'ul',
          { className: 'filters' },
          _react2.default.createElement(_FilterList2.default, _extends({}, state, { actions: actions }))
        ),
        _react2.default.createElement(
          'button',
          {
...
},{"react":12,"./components/TodoList":36,"./components/FilterList":37}],4:[function(require,module,exports) {
'use strict';
...
(function () {
  var state = new Proxy({ todos: [], selected: 'all' }, {
    set: function set(state, key, value) {
      state[key] = value;
      (0, _reactDom.render)((0, _App2.default)(state, actions), document.querySelector('#app'));
      return true;
    }
  });

  var getId = function getId(_) {
    return Math.random().toString();
  };

  var newTodo = function newTodo(title) {
    return {
      id: getId(),
      title: title,
      done: false
  ...
  var actions = {
    addTodo: function addTodo(title) {
      state.todos = [].concat(_toConsumableArray(state.todos), [newTodo(title)]);
    },
    ...
    clearCompleted: function clearCompleted(_) {
      state.todos = state.todos.filter(function (todo) {
        return !todo.done;
      });
    },
    checkAllTodos: function checkAllTodos(_) {
      state.todos = state.todos.map(function (todo) {
        return _extends({}, todo, { done: true });
      });
    },
    uncheckAllTodos: function uncheckAllTodos(_) {
      state.todos = state.todos.map(function (todo) {
        return _extends({}, todo, { done: false });
      });
    }
  };
...
},{"react-dom":10,"./App":8}],33:[function(require,module,exports) {
...
//# sourceMappingURL=/js.e9d0fa77.map