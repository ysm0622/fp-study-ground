...
},{"hyperapp":5}],4:[function(require,module,exports) {
'use strict';
...
},{"hyperapp":5}],1:[function(require,module,exports) {
'use strict';
...
(function () {
      ...
      return function (state) {
        return {
          todos: state.todos.map(function (todo) {
            return todo.id != id ? todo : _extends({}, todo, {
              done: !todo.done
            });
          })
        };
  ...
  var enterHandler = function enterHandler(actions) {
    return function (e) {
  ...
  var TodoList = function TodoList(_ref) {
    ...
    return todos.filter(function (todo) {
      ...
      return (0, _hyperapp.h)(_TodoItem2.default, _extends({}, todo, actions));
    }).reverse();
  };
...
},{"hyperapp":5,"./TodoItem":3,"./FilterItem":4}]},{},[1], null)