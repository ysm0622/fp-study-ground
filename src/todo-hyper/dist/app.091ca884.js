  ...
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)('input', {
      ...
      onclick: function onclick() {
        return actions.updateTodo(todo.id);
      }
    }),
    (0, _hyperapp.h)(
      'label',
...
(function () {
  ...
  var actions = {
    initTodo: function initTodo(state) {
      return {
      ...
      (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          ...
          (0, _hyperapp.h)(
            'ul',
            { 'class': 'todo-list' },
            (0, _hyperapp.h)(TodoList, _extends({}, state, { actions: actions }))
          )
        ),
        (0, _hyperapp.h)(
          'footer',
          ...
          (0, _hyperapp.h)(
            'ul',
            { 'class': 'filters' },
            (0, _hyperapp.h)(FilterList, _extends({}, state, actions))
          ),
          (0, _hyperapp.h)(
            'button',
            { 'class': 'clear-completed', onclick: function onclick() {
                return actions.add20ktodos();
              } },
            'Clear completed'
          )
        )
  ...
  // actions.initTodo(state)
  var main = (0, _hyperapp.app)(state, actions, view, document.body);
})();
},{"hyperapp":8,"./TodoItem":7,"./FilterItem":6}],17:[function(require,module,exports) {
...
//# sourceMappingURL=/app.091ca884.map