...
exports.default = {
  addTodo: function addTodo(title) {
    return function (state) {
      return {
        todos: [].concat(_toConsumableArray(state.todos), [newTodo(title)])
      };
    };
  },
  ...
  checkAllTodos: function checkAllTodos(state) {
    return {
  ...
  uncheckAllTodos: function uncheckAllTodos(state) {
    return {
      todos: state.todos.map(function (todo) {
  ...
  add20ktodos: function add20ktodos() {
    return {
      todos: Array.from(Array(20000).keys()).map(function (v) {
        return newTodo(v);
      })
    };
  }
...
exports.default = function (_ref) {
  ...
  return (0, _hyperapp.h)(
    'li',
    { 'class': todo.done && 'completed', key: todo.id },
    (0, _hyperapp.h)('input', {
      'class': 'toggle',
      type: 'checkbox',
      checked: todo.done,
    ...
    (0, _hyperapp.h)('button', { 'class': 'delete', onclick: function onclick() {
        return actions.removeTodo(todo.id);
      } })
  );
};
},{"hyperapp":9}],10:[function(require,module,exports) {
'use strict';
...
exports.default = function (_ref) {
  ...
  return todos.filter(function (todo) {
    ...
    return (0, _hyperapp.h)(_TodoItem2.default, { todo: todo, actions: actions });
  }).reverse();
};
},{"hyperapp":9,"./TodoItem":20}],18:[function(require,module,exports) {
'use strict';
...
},{"hyperapp":9}],11:[function(require,module,exports) {
'use strict';
...
exports.default = function (_ref) {
  ...
  return ['all', 'active', 'completed'].map(function (filter) {
    return (0, _hyperapp.h)(_FilterItem2.default, {
      filter: filter,
      selected: selected,
...
},{"hyperapp":9,"./FilterItem":18}],7:[function(require,module,exports) {
'use strict';
    ...
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          'ul',
          { 'class': 'todo-list' },
          (0, _hyperapp.h)(_TodoList2.default, _extends({}, state, { actions: actions }))
        )
      ),
      (0, _hyperapp.h)(
        'footer',
        ...
        (0, _hyperapp.h)(
          'ul',
          { 'class': 'filters' },
          (0, _hyperapp.h)(_FilterList2.default, _extends({}, state, actions))
        ),
        (0, _hyperapp.h)(
          'button',
          {
            ...
            onclick: function onclick() {
              return actions.clearCompleted(state);
            }
          },
          'Clear completed'
        )
...
},{"hyperapp":9,"./components/TodoList":10,"./components/FilterList":11}],4:[function(require,module,exports) {
'use strict';
...
(0, _hyperapp.app)(_state2.default, _actions2.default, _view2.default, document.body);
},{"hyperapp":9,"./state":5,"./actions":6,"./view":7}],19:[function(require,module,exports) {
...
//# sourceMappingURL=/js.f20584da.map